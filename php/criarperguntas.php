...
<html lang="pt-br">
    ...
    <body>
        ...
        <form class="container-form" action="acaocriarperguntas.php " method="post">
            <input type="hidden" name="idUser" value="<?php echo $idUser ?>" />
            <div class="container-form-title">
                <input type="text" class="titulo-form" name="tituloForm" placeholder="Título" />
                <input type="text" class="amount-form" name="valorTotQuestn" placeholder="Valor total" />
            </div>
            ...
            <footer class="footer">
                ...
                <input type="submit" class="botaoSalva" name="btn-salvar" value="Salvar formulário" />
            </footer>
        </form>
    </body>
